...
namespace geg {
  ...
  public:
    ...
    char category_flags = EventCategory::EventCategoryInput | EventCategory::EventCategoryKeyboard;
  ...
  public:
    ...
    char category_flags = EventCategory::EventCategoryInput | EventCategory::EventCategoryMouse;
  ...
  public:
    ...
    char category_flags = EventCategoryMouse | EventCategoryInput | EventCategoryMouseButton;

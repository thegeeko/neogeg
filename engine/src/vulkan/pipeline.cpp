...
//											.value();
//
//		pipeline_layout = m_device->vkdevice.createPipelineLayout(vk::PipelineLayoutCreateInfo{
//				.setLayoutCount = 1,
//				.pSetLayouts = &layout,
...
//
//	GraphicsPipeline::~GraphicsPipeline() {
//		m_device->vkdevice.destroyPipeline(pipeline);
//		m_device->vkdevice.destroyPipelineLayout(pipeline_layout);
//	}
//}		 // namespace geg::vulkan
